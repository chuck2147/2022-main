...
public class ControllerConstants {
    ...
    //INTAKE BUTTONS
    public static AxisTrigger INTAKE_IN_BUTTON = new AxisTrigger(driverController, 2);
    public static AxisTrigger INTAKE_OUT_BUTTON = new AxisTrigger(driverController, 3);
    //SHOOTER BUTTONS
    ...
    //INDEXER BUTTONS
    public static JoystickButton INDEX_IN = driverController.getButton(Controller.Button.LeftBumper);
    public static JoystickButton INDEX_OUT = driverController.getButton(Controller.Button.RightBumper);
    //MISC BUTTONS
