...
public class ControllerConstants {
    ...
    public static JoystickButton CLIMB_LEFT_UP_BUTTON = driverController.getButton(Controller.Button.X);
    ...
    public static JoystickButton BEHIND_TARMAC_SHOT = operatorController.getButton(Controller.Button.X);
